package com.egzonberisha.weatherappandroid.adapters;
...
public class WeatherForecastAdapter extends RecyclerView.Adapter<WeatherForecastAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_temperature.setText(new StringBuilder(String.valueOf((int)weatherForecastResult.list.get(position).main.getTemp()-273)).append("°C"));
